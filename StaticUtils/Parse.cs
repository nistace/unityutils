...
namespace NiUtils.StaticUtils {
	public static class Parse {
		...
		public static long Long(string str) => TryLong(str, out var res) ? res : throw new FormatException($"Cannot parse {str} to long");
		...
		public static bool TryLong(string str, out long res) => long.TryParse(str, NumberStyles.Integer, CultureInfo.InvariantCulture, out res);
