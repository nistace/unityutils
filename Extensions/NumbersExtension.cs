...
namespace NiUtils.Extensions {
	public static class NumbersExtension {
		...
		private static bool Between(this float value, float min, float max, bool minIncluded, bool maxIncluded) =>
			value > min && value < max || minIncluded && value == min || maxIncluded && value == max;
